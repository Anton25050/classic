         ...
         <nav class="navbar navbar-dark bg-dark">
            <div class="container">
                ...
                <a class="navbar-brand">navbar</a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?= $urlManager->createUrl(['country/index']) ?>">первая</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= $urlManager->createUrl(['country/create']) ?>">вторая</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= $urlManager->createUrl(['country/create']) ?>">обращение</a>
                    </li>
                </ul>
            </div>
        </nav>
